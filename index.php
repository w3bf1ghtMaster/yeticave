...
$user_name = 'Darth Vader'; // укажите здесь ваше имя

$cats = ['Доски и лыжи','Крепления','Ботинки','Одежда','Инструмены','Разное'];
...
function price_format(float $num) : string {
    $number = ceil($num);
        ...
        <ul class="lots__list">
            ...
            <li class="lots__item lot">
                <div class="lot__image">
                    <img src="<?=$card['url']?>" width="350" height="260" alt="<?=$card['title']?>">
                </div>
                <div class="lot__info">
                    <span class="lot__category"><?=$card['category']?></span>
                    <h3 class="lot__title"><a class="text-link" href="pages/lot.html"><?=$card['title']?></a></h3>
                    <div class="lot__state">
                        <div class="lot__rate">
                            <span class="lot__amount">Стартовая цена</span>
                            <span class="lot__cost"><?=price_format($card['price']);?></span>
                        </div>
